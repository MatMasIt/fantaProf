...
class AccountChangePassword extends Test
{
    public function __construct()

    {
        parent::__construct("Change password", "Change password with old password and session token");
    }
    public function run(array $resultValues): bool
    {
        ...
        $fields = [
            ...
            'token'         => $resultValues[count($resultValues) - 1]["data"]["token"],
            'password' => "prova",
            'newPassword' => "prova2"
        ];
